...
int main(int argc, char *argv[]) {
    ...
    QGraphicsScene *scene = new QGraphicsScene(0, 0, 554, 540);

    QGraphicsRectItem *rect1 = new QGraphicsRectItem(20,20,158,100);
    QGraphicsRectItem *rect2 = new QGraphicsRectItem(198,20,158,100);
    QGraphicsRectItem *rect3 = new QGraphicsRectItem(376,20,158,100);
    QGraphicsRectItem *workspace = new QGraphicsRectItem(20,140,514,380);
    QGraphicsRectItem *sidebar = new QGraphicsRectItem(20,140,158,380);
    QGraphicsRectItem *trash = new QGraphicsRectItem(342,456,64,64);
    QGraphicsRectItem *save = new QGraphicsRectItem(406,456,64,64);
    QGraphicsRectItem *load = new QGraphicsRectItem(470,456,64,64);

    //creates an item to put into the scene

    QPixmap pic("C:\\Users\\16136\\CLionProjects\\qtTest1\\img.jpg.png");
    ...
    Label *life = new Label(30,150,QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\life.png"), "Life");
    Label *death = new Label(104,150, QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\death.png"), "Death");
    Label *wood = new Label(30,224, QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\wood (1).png"), "Wood");
    Label *water = new Label(104,224, QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\Water SBG.png"), "Water");
    Label *fire = new Label(30,298,QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\smol fire clone.png"), "Fire");
    Label *love = new Label(104,298, QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\Love SBG.png"), "Love");
    Label *electricity = new Label(30,372, QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\Electricity SBG.png"), "Electricity");
    Label *air = new Label(104,372, QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\Air SBG.png"), "Air");
    Label *cupcake = new Label(30,446, QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\cupcake.png"), "Cupcake");
    Label *toothbrush = new Label(104,446 , QPixmap("C:\\Users\\16136\\CLionProjects\\Alchemy-Shop-Testing\\Toothbrush SBG.png"), "Toothbrush");
    ...
    //view -> setScene(scene) also works
    view -> show();
